...
(function () {
  ...
  const SHIULI_SVG = `<svg width="42" height="42" viewBox="0 0 42 42">
    <defs>
      <filter id="shiuliGlow" x="-20%" y="-20%" width="140%" height="140%">
        <feDropShadow dx="0" dy="3" stdDeviation="2.5" flood-color="#000" flood-opacity="0.4"/>
      </filter>
    </defs>
    <g transform="translate(21,21)" filter="url(#shiuliGlow)">
      <!-- 5 White Petals -->
      <path d="M0,-4 Q-5,-13 0,-19 Q5,-13 0,-4" fill="#FFFFFF"/>
      <path d="M0,-4 Q-5,-13 0,-19 Q5,-13 0,-4" fill="#FFFFFF" transform="rotate(72)"/>
      <path d="M0,-4 Q-5,-13 0,-19 Q5,-13 0,-4" fill="#FFFFFF" transform="rotate(144)"/>
      <path d="M0,-4 Q-5,-13 0,-19 Q5,-13 0,-4" fill="#FFFFFF" transform="rotate(216)"/>
      <path d="M0,-4 Q-5,-13 0,-19 Q5,-13 0,-4" fill="#FFFFFF" transform="rotate(288)"/>

      <!-- Vibrant Saffron Core -->
      <circle r="4.5" fill="#FF5500"/>
      <circle r="2" fill="#FF8800"/>
    </g>
  </svg>`;
